          ...
          <div class="col-lg-9">
            ...
            <div class="card box mt-4 card-child">
              <div class="card-header head">
                <h4 class="h4">Agregar Carrera</h4>
              </div>
              <form action="" method="POST" id="note-form" class="card-body">
                ...
                <div id="Ocultar_1">
                    ...
                    <div class="form-group">
                      <textarea required id="perfil_ingreso" name="perfil_ingreso" cols="30" rows="10" class="form-control descrip" value="" placeholder="Perfil ingreso"></textarea>
                    </div>
                    <div class="form-group">
                      <textarea required id="perfil_egreso" name="perfil_egreso" cols="30" rows="10" class="form-control descrip" value="" placeholder="Perfil egreso"></textarea>
                    </div>
