...
<body>
  ...
  <!-- <section id="topbar" class="d-none d-md-block">
...
<link rel="stylesheet" type="text/css" href="CSS/ash.css">
     ...
     <form><center>
        <div >  
           INFORMACIÓN
            <hr class="new1">
           <p>          
             <label>Información general (Presentación, Contacto, Ubicación, etc.)</label><br><br>  
             <textarea name="mensaje"></textarea><br>
       </div> 
        <div>
           <br>
             CONTENIDO MULTIMEDIA<hr class="new2" >
           <p>
             Subir Logo de Universidad:
             <input type="file" name="adjunto" accept=".png" multiple>
           </p>
           <br>  
       </div>
       <div  class="left">
           Subir Videos:<br>
           <input type="file" name="video" accept=".mp4" multiple>
       </div>
        <div class="right">    
           Subir Fotos:<br>
             <input type="file" name="fotos" accept=".jpg,.png" multiple>
       </div>  
       <div>   
              <p>OFERTA EDUCATIVA</p><hr class="new3">
             <div class="left">
             <label>Licenciatura en Administración</label><br><br>  
             <textarea name="mensaje"></textarea><br></div>
          <div class="video">   Subir Videos:<br>
              <input type="file" name="video" accept=".mp4" multiple>
         </div>
          <div class="foto">  Subir Fotos:<br>
              <input type="file" name="fotos" accept=".jpg,.png" multiple>
          </div>
             <input class="left" type="button" name="agregar" value="Agregar Carrera +">
       </div><br>
        <input type="button" name="subir" value="Subir Información">
          ...
          <!--<div class="col-lg-6 pt-4 pt-lg-0">
            ...
            <a href="register.html" class="btn-learn-more">Saber más</a>
          </div>-->
        </div>
        ...
        <div class="tab-content" data-aos="fade-up">
          ...
          <!-- <ul class="nav nav-tabs row d-flex">
            <li class="nav-item col-3" data-aos="zoom-in">
              <a class="nav-link active show" data-toggle="tab" href="http://www.decidetusestudios.sep.gob.mx/vista/test-vocacional/registro" target="_blank">
                <i class="ri-gps-line"></i>
                <h4 class="d-none d-lg-block">Realizar TEST</h4>
              </a>
            </li>
  ...
  <footer id="footer">
    ...
    <!-- <section id="topbar" class="d-none d-md-block">
      <div class="container topbar-elements clearfix">
      

          <div class="float-left">
            <img src="assets/img/topbar_logo_1.jpg" class="topbar-img-tam1" alt="">
            <img src="assets/img/topbar_logo_2.jpg" class="topbar-img-tam2" alt="">
          </div>

          <div class="float-right">
            <img src="assets/img/ceiba_cuadrado-favicon.png" class="topbar-img-tam2" alt="">
            <img src="assets/img//topbar_logo_3.png" class="topbar-img-tam3" alt="">
          </div>
